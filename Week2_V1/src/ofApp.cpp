...
int idx = 0;
	...
	int yPos = ofMap(sin(ofGetElapsedTimef()), -1, 1, 0.0, 150);

	//Right side oscillating circles 
	ofSetColor(r, g, b);
	ofDrawCircle(xPos1, 100 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos2, 200 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos3, 300 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos4, 400 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos5, 500 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos6, 600 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos7, 700 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos8, 800 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(xPos8, 900 + yPos, n);
	...
	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos1, 150 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos2, 250 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos3, 350 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos4, 450 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos5, 550 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos6, 650 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos7, 750 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos8, 850 + yPos, n);

	ofSetColor(r, g, b);
	ofDrawCircle(x2Pos9, 950 + yPos, n);
